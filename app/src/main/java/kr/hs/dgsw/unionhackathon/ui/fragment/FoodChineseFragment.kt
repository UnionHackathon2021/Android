...
import kr.hs.dgsw.unionhackathon.ui.viewmodel.FoodChineseViewModel

class FoodChineseFragment : Fragment() {

    private val viewModel: FoodChineseViewModel by viewModels()
