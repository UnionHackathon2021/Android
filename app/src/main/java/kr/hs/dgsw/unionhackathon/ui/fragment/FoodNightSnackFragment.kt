...
import kr.hs.dgsw.unionhackathon.ui.viewmodel.FoodNightSnackViewModel

class FoodNightSnackFragment : Fragment() {

    private val viewModel: FoodNightSnackViewModel by viewModels()
