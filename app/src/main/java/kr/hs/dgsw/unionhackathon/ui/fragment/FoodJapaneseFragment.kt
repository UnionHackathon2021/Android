...
import kr.hs.dgsw.unionhackathon.ui.viewmodel.FoodJapaneseViewModel

class FoodJapaneseFragment : Fragment() {

    private val viewModel: FoodJapaneseViewModel by viewModels()
