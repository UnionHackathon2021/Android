...
import kr.hs.dgsw.unionhackathon.ui.viewmodel.FoodKoreanViewModel

class FoodKoreanFragment : Fragment() {

    private val viewModel: FoodKoreanViewModel by viewModels()
