...
import kr.hs.dgsw.unionhackathon.ui.viewmodel.FoodChickenViewModel

class FoodChickenFragment : Fragment() {

    private val viewModel: FoodChickenViewModel by viewModels()
